...
$plugin_name="Antenna diversity"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Administration of the antennas diversity"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/antenna.png"; // BY DEFAULT
$plugin_icon_selected="images/antenna_hv.png"; // BY DEFAULT
?>
