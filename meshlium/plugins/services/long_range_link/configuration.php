...
$plugin_name="Long range link"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Modify madwifi driver behaviour for long range links."; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/longrange2.png"; // BY DEFAULT
$plugin_icon_selected="images/longrange2_hv.png"; // BY DEFAULT
?>
