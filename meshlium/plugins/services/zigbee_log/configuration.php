...
$plugin_name="Zigbee log"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Allows to log Xbee traffic to a file"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/zb_sniffer.png"; // BY DEFAULT
$plugin_icon_selected="images/zb_sniffer_hv.png"; // BY DEFAULT
?>