...
$plugin_description="View and edit dhcp configuration options"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/dhcp.png"; // BY DEFAULT
$plugin_icon_selected="images/dhcp_hv.png"; // BY DEFAULT
