...
$plugin_name="Olsr configuration"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="View and edit olrsd configuration options"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/olsr.png"; // BY DEFAULT
$plugin_icon_selected="images/olsr_hv.png"; // BY DEFAULT
?>
