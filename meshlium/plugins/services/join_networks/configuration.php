...
$plugin_name="Join networks new"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Modify iptables in order to allow fordwarding between interfaces"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/networks.png"; // BY DEFAULT
$plugin_icon_selected="images/networks_hv.png"; // BY DEFAULT
