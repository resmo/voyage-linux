...
$plugin_name="HD format and encryption"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="HD encryption and format administration"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/hdformat.png"; // BY DEFAULT
$plugin_icon_selected="images/hdformat_hv.png"; // BY DEFAULT
?>
