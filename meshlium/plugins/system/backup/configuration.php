...
$plugin_name="Backup"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Backup configuration files of meshlium"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/backup.png"; // BY DEFAULT
$plugin_icon_selected="images/backup_hv.png"; // BY DEFAULT
?>
