...
$plugin_name="iperf"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Allows to do iperf to addresses through a choosen interface"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/iperf.png"; // BY DEFAULT
$plugin_icon_selected="images/iperf_hv.png"; // BY DEFAULT
?>