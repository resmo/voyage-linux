...
$plugin_name="GPS"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="GPS module interface"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/gps.png"; // BY DEFAULT
$plugin_icon_selected="images/gps_hv.png"; // BY DEFAULT
?>
