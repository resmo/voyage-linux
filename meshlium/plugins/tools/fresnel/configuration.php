...
$plugin_name="Fresnel configuration"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="View and edit Fresnel configuration of wifi adapters"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/fresnel_icon.png"; // BY DEFAULT
$plugin_icon_selected="images/fresnel_icon_hv.png"; // BY DEFAULT
?>
