...
$plugin_name="GPRS"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="GPRS interface management"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/gprs.png"; // BY DEFAULT
$plugin_icon_selected="images/gprs_hv.png"; // BY DEFAULT
?>
