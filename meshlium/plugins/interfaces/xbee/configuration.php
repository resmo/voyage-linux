...
$plugin_description="Xbee PRO configuration"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/zigbee.png"; // BY DEFAULT
$plugin_icon_selected="images/zigbee_hv.png"; // BY DEFAULT
?>
