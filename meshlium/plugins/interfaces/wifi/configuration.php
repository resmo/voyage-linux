...
$plugin_name="Wifi"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Wifi interfaces management"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/wifi.png"; // BY DEFAULT
$plugin_icon_selected="images/wifi_hv.png"; // BY DEFAULT
?>
