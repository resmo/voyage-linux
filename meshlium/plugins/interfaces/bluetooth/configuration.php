...
$plugin_name="Bluetooth configuration"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="View and edit hcid.conf configuration options"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/bt.png"; // BY DEFAULT
$plugin_icon_selected="images/bt_hv.png"; // BY DEFAULT
?>
