...
$html='
<div class="title">Shutdown / Restart</div>
<script type="text/javascript">


function system_shutdown()
{
	//simple_ajax_call(\'shutdown\',\'\',\'output\',\''.$section.'\',\''.$plugin.'\');
	//complex_ajax_call(\'shutdown\',\'form_null\',\'output\',\''.$section.'\',\''.$plugin.'\');
...
{
	//simple_ajax_call(\'restart\',\'\',\'output\',\''.$section.'\',\''.$plugin.'\');
	//complex_ajax_call(\'restart\',\'form_null\',\'output\',\''.$section.'\',\''.$plugin.'\');
...
<div class="title2">
<table></tr>
<td class="media_button_medium" onclick="system_shutdown()">
Shutdown</td>
<td class="media_button_medium" onclick="system_restart()">
Restart</td>
</tr></table>
</div>
